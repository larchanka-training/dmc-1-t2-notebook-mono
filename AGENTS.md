...
| _Sprint #3 deliverables_ | **Relocated** out of the mono to the workspace docs repo at `docs/sprint-3-deliverables/` (TL production-readiness, E1–E5, DevOps runbook, QA release report). No longer tracked here. |
