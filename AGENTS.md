...
| [`security-review.md`](docs/security-review.md) | Offensive security self-review: XSS, JWT, API authz, execution sandbox, prompt injection, infra + additional domains (CSRF, offline/IndexedDB data, clickjacking, SSRF, info disclosure, DoS/ReDoS, supply chain) — per-finding test/exploit/defend, severity register, remediation roadmap |
