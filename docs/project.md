...
| 2026-09-22 | Legacy AWS preview workflows audit and Bedrock deprecation | Done; 9 workflows archived in `archive/aws-workflows/`, secrets audited, Bedrock deprecated across docs and configs, tracking issue larchanka-training/js-notebook#186 closed |
...
provider (Issue #186), with access restricted to allowlisted accounts until pinned
