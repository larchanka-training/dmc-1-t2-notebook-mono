...
- **Бэкенд (Node.js):** Jest — бизнес-логика: генерация и валидация OTP, кодирование JWT, CRUD блокнотов, логика шаринга, логика fallback-цепочки LLM (WASM → бэкенд → OpenAI)
