...
| Backup automation & disposable restore | `scripts/backup-aeza.sh`, `scripts/restore-disposable-db.sh`, `docs/backup-restore.md` |
| GitHub Environment to configure | `aeza-production` |

The next gates are post-cutover observation (Phase G), pinned OpenRouter
